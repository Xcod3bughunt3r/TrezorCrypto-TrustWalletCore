...
Pod::Spec.new do |s|
  s.name         = 'TrezorCrypto-TrustWalletCore'
  s.version      = version
  s.summary      = 'Trust Wallet core data structures and algorithms.'
  s.homepage     = 'https://github.com/Xcod3bughunt3r/TrezorCrypto-TrustWalletCore'
  s.license      = 'MIT'
  ...
  s.source = {
    git: 'git@github.com:Xcod3bughunt3r/TrezorCrypto-TrustWalletCore.git',
    tag: version,
    submodules: true
  }
